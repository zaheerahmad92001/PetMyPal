...
function Interested({ events, pressInterestEvent, pressGoingEvent, navigation, ...rest }) {
        ...
        renderItem={({ item, i }) => {
          return (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('EventDetails', { item: item, btnShow: true, goingShow: false, interestShow: true, color: true })}
              key={item.id}>
