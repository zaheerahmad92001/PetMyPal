...
function Interested({ events, navigation, ...rest }) {
      ...
      <FlatList
        ...
        renderItem={({ item }, i) => {
          return (
            ...
            //        <Text style={{ marginLeft: 8, color: 'gray',fontWeight:'bold' }}>{this.getFullDate(item?.start_date)}</Text>
            //        <Text style={{ color: 'gray',fontWeight:'bold' }}>{' To ' + this.getFullDate(item?.end_date)}</Text>
            //      </View>
            //      <View style={{  flexDirection: 'row', alignItems:'flex-end',marginBottom:1 }}>
            //        <Text style={{ marginLeft: 4, color: 'gray',fontWeight:'bold' }}><Text style={{fontWeight:'bold',fontSize:16}}>@</Text>{this.getFullTime(item?.start_time)}</Text>
            //        <Text style={{ color: 'gray',fontWeight:'bold' }}>{'-' + this.getFullTime(item?.end_time)}</Text>
            //      </View>
            //    </View>
            ...
            //        </View>
            //        </View>
            //        <Text style={{  color: 'gray', marginTop: 12,width:'100%',textAlign:'center' }}>{item.description}</Text>
            //    {this.buttonShow()}
